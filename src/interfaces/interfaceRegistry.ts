...
import { Attestation, Identity, IdentityRecord, IdentityStage, IdentityType, MetadataRecord } from 'sample-polkadotjs-typegen/interfaces/identity';
...
import { Balance2 } from 'sample-polkadotjs-typegen/interfaces/treauryRewards';
...
export interface InterfaceRegistry {
  ...
  'Option<MetadataRecord>': Option<MetadataRecord>;
  'Vec<MetadataRecord>': Vec<MetadataRecord>;
  IdentityStage: IdentityStage;
  'Option<IdentityStage>': Option<IdentityStage>;
  'Vec<IdentityStage>': Vec<IdentityStage>;
  IdentityRecord: IdentityRecord;
  'Option<IdentityRecord>': Option<IdentityRecord>;
  'Vec<IdentityRecord>': Vec<IdentityRecord>;
  IdentityType: IdentityType;
  'Option<IdentityType>': Option<IdentityType>;
  'Vec<IdentityType>': Vec<IdentityType>;
